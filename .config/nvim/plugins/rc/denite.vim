...
nmap <silent> <C-u>f :<C-u>Denite file/rec -winheight=10<CR>
nmap <silent> <C-u>p :<C-u>Denite grep -winheight=10 -auto-preview=true<CR>
nmap <silent> <C-l> :<C-u>Denite grep -winheight=20 -buffer-name=search-buffer-denite<CR>i
nmap <silent> <C-g> :<C-u>DeniteCursorWord grep -winheight=20 -buffer-name=search-buffer-denite<CR>
nmap <silent> <C-u>b :<C-u>Denite buffer -winheight=15 -mode=normal<CR>
